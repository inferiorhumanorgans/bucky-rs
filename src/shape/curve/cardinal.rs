...
impl CurveContext for CurveCardinalContext {
    ...
    fn end_line(&mut self) {
        match self.line_state {
            ...
            2 => self.path.line_to(Vector2F::new(self.x[2] as f32, self.y[2] as f32)),
...
fn expected_results() {
...

    {
        ...
        assert_eq!("M 0 1 C 0 1 0.6666667 3 1 3 C 1.3333334 3 2 1 2 1", line.generate(data));
    }

    {
        ...
        assert_eq!("M 0 1 C 0 1 0.6666667 3 1 3 C 1.3333334 3 1.6666666 1 2 1 C 2.3333333 1 3 3 3 3", line.generate(data));
    }
...
fn expected_results_with_different_tension() {
...

    {
        ...
        let data : &[(f64, f64)] = &[(0., 1.), (1., 3.), (2., 1.), (3., 3.)];
        assert_eq!("M 0 1 C 0 1 0.8333333 3 1 3 C 1.1666666 3 1.8333334 1 2 1 C 2.1666667 1 3 3 3 3", line.generate(data));
    }
}
